...
namespace VaxWise.API.Services
{
    public class FinancialService : IFinancialService
    {
        ...
        public async Task<List<FinancialResponseDto>> GetAllTransactionsAsync()
        {
            var transactions = await _context.Financials
                .Include(f => f.Animal)
                .OrderByDescending(f => f.TransactionDate)
        ...
        public async Task<AnimalCostDto> GetAnimalCostAsync(int animalId)
        {
            var animal = await _context.Animals
            ...
            // Get all expenses linked to this animal
            ...
            // Get sale income if animal was sold
